    ...
    <TermsPageContainer>
      <Container style={{ margin: "2rem auto 3rem" }}>
        ...
        <OptimizedPara>
          ...
          THESE TERMS AND CONDITIONS, AND EXPRESSLY CONSENT TO ACORNAUTO.COM
        ...
        <NormalPara>
          ...
          about you for a variety of purposes outlined in AcornAuto.com's
          ...
          additional, secondary purposes, which are provided in AcornAuto.com's
          Privacy Policy.
        </NormalPara>
        <NormalPara>
          ...
          about how AcornAuto.com collects and processes Personal Information
        ...
        <NormalPara>
          AcornAuto.com operates the Site as an online advertising and research
          service for tire buyers and auto service.
        </NormalPara>
        <NormalPara>
          Advertisers on AcornAuto.com may include information about special
          offers, incentives, or pricing programs associated with a specific
          brand, model, or vehicle ("Offers"). AcornAuto.com is not responsible
        ...
        <NormalPara>
          By accessing the Site and Services, you agree that AcornAuto.com is
          ...
          AcornAuto.com in providing the Services, including whether third party
          ...
          use in connection with the Services. You agree that AcornAuto.com is
        ...
        <NormalPara>
          ...
          issues, etc.) beyond the reasonable control of AcornAuto.com for which
          AcornAuto.com shall have no liability.
        </NormalPara>
        <NormalPara>
          ...
          Unless otherwise permitted by AcornAuto.com, any alteration,
          ...
          purpose constitutes an infringement of AcornAuto.com’s intellectual
          ...
          written permission from AcornAuto.com. You shall not remove or modify
        ...
        <NormalPara>
          ...
          ("Materials") to the Site, you hereby grant to AcornAuto.com and its
          ...
          AcornAuto.com and its affiliates and subsidiaries a royalty-free right
          ...
          Materials will not cause injury to any person or entity. AcornAuto.com
        ...
        <NormalPara>
          ...
          older to access and use the Forums. AcornAuto.com and its affiliates
          ...
          cause injury to any person or entity. AcornAuto.com takes no
        ...
        <OptimizedPara>D. ACORNAUTO.COM RIGHTS</OptimizedPara>
        <NormalPara>
          AcornAuto.com does not monitor the Materials, Forums or Listing
          Service (collectively, “Content”) posted or transmitted by you and/or
          other third-party information providers. AcornAuto.com reserves the
          ...
          AcornAuto.com (a) will not be liable to any claims, actions or
        ...
        <NormalPara>
          ...
          marks owned by AcornAuto.com and its affiliates and subsidiaries. You
          agree not to use any trademarks, service marks, names, logos, or other
          identifiers of AcornAuto.com or its employees, affiliates,
          subsidiaries, independent contractors, and providers without the prior
          written permission of AcornAuto.com, or: (i) in, as, or as part of,
          any third parties; (ii) to identify non-AcornAuto.com products or
          services; or (iii) in a manner likely to cause confusion or that
          implies that AcornAuto.com sponsors or endorses or is otherwise
          ...
          legal@AcornAuto.com or mailed to AcornAuto.com 591 S Lapeer Rd, Lake
          Orion, MI 48362.
        </NormalPara>
        <NormalPara>
          Please note that all software programming, including without
          limitation all HTML and other code contained in the Site
          (collectively, "Software"), is owned by AcornAuto.com and its
        ...
        <NormalPara>
          It is the policy of AcornAuto.com to respond to claims of intellectual
          property infringement. AcornAuto.com will promptly process and
        ...
        <NormalPara>
          ...
          AcornAuto.com, its affiliates and subsidiaries, and their respective
        ...
        <NormalPara>
          ...
          IS AT YOUR OWN RISK. ACORNAUTO.COM, ITS SUBSIDIARIES AND AFFILIATES
          ...
          ARE PROVIDED ON AN "AS IS, AS AVAILABLE" BASIS, AND ACORNAUTO.COM, ITS
          ...
          SITE IS SUPPLIED BY THE SELLER OR OTHER THIRD PARTIES. ACORNAUTO.COM
          ...
          INFORMATION ABOUT A VEHICLE ADVERTISED ON THE SITE. ACORNAUTO.COM
          CANNOT AND DOES NOT VERIFY OR WARRANT THE ACCURACY OR COMPLETENESS OF
          SUCH INFORMATION. ACORNAUTO.COM RESERVES THE RIGHT, IN ITS SOLE
          ...
          ACORNAUTO.COM DOES NOT MAKE AND EXPRESSLY DISCLAIMS ANY
        ...
        <NormalPara>
          ACORNAUTO.COM, ITS SUBSIDIARIES AND AFFILIATES, AND THEIR RESPECTIVE
          ...
          WILL THE AGGREGATE MAXIMUM LIABILITY OF ACORNAUTO.COM, ITS
        ...
        <NormalPara>
          ...
          AcornAuto.com reserves the right to stop offering the SMS Service at
          any time with or without notice.
        </NormalPara>
        <OptimizedPara>By opting into the SMS Service, you:</OptimizedPara>
        <NormalPara>
          authorize AcornAuto.com to use autodialer or non-autodialer technology
        ...
        <NormalPara>
          ...
          you send the message “STOP” to AcornAuto.com, we will send you a reply
          ...
          command and agree that AcornAuto.com and its service providers will
          ...
          receive text messages from AcornAuto.com through any other programs
        ...
        <NormalPara>
          ...
          etc.) as a result of using the SMS Service. AcornAuto.com may add or
          remove any wireless carrier from the SMS Service at any time without
          notice. AcornAuto.com and mobile carriers are not responsible for any
        ...
        <NormalPara>
          ...
          you agree to notify AcornAuto.com by emailing info@AcornAuto.com
        </NormalPara>
        <OptimizedPara>12. INDEMNIFICATION</OptimizedPara>
        <NormalPara>
          By using the Site, you agree to indemnify, defend and hold
          AcornAuto.com, and its officers, subsidiaries, licensors, successors,
          ...
          AcornAuto.com within seven (7) days of the filing of any Claims, and
          AcornAuto.com reserves, and you grant to AcornAuto.com, the right to
        ...
        <NormalPara>
          AcornAuto.com does not guarantee or warrant that the Site, Services,
          ...
          or destructive properties, nor can AcornAuto.com provide any assurance
          ...
          secure medium and privacy cannot be guaranteed. AcornAuto.com will not
          be responsible for any damages you or any third party may suffer as a
          result of the transmission that you make to AcornAuto.com through the
          Internet, or that you expressly or implicitly authorize AcornAuto.com
        ...
        <NormalPara>
          You understand and agree that in AcornAuto.com's sole discretion, and
          without prior notice, your access to the Site or Services may be
          terminated or suspended, and AcornAuto.com may exercise any other
          remedy available and remove any Content if AcornAuto.com believes that
          your use of the Site and/or any Content you provide (a) violate (i)
          these Terms and Conditions, (ii) the rights of AcornAuto.com, its
          ...
          monetary damages may not provide a sufficient remedy to AcornAuto.com
          ...
          requirement that AcornAuto.com post a bond. AcornAuto.com is not
          required to provide any refund to you if you are terminated as an
          authorized user of the Site because, in AcornAuto.com’s sole
        ...
        <NormalPara>
          ...
          circumstances shall AcornAuto.com or its affiliates and subsidiaries,
        ...
        <NormalPara>
          ...
          "junk mail" or unsolicited mass mailing or "spam" to AcornAuto.com
          ...
          promote products and services to AcornAuto.com advertisers; (l) using
          ...
          AcornAuto.com's hardware and software infrastructure (collectively,
          "Prohibited Activities").
        </NormalPara>
        <OptimizedPara>17. PRIVACY NOTICE</OptimizedPara>
        <NormalPara>
          Your use of the Site and Services may involve the transmission of your
          personal information. AcornAuto.com’s notices regarding the collection
          and use of personal information are governed by the AcornAuto.com’s
        ...
        <NormalPara>
          ...
          and Canada. AcornAuto.com makes no representation that the Site, or
          ...
          States embargoes goods. In addition, AcornAuto.com software may not be
        ...
        <NormalPara>
          ...
          UNDERSTAND THAT ACORNAUTO.COM AND YOU EACH WAIVE YOUR RESPECTIVE RIGHT
          TO A TRIAL BY JURY. AcornAuto.com and you each agree to use best
          ...
          and/or its Services. If AcornAuto.com and you cannot reach a written
          settlement agreement within thirty (30) days of the raising of the
          controversy or claim, AcornAuto.com and you shall submit the dispute
        ...
        <NormalPara>
          ACORNAUTO.COM AND YOU AGREE THAT ANY DISPUTES, CLAIMS AND/OR CAUSES OF
          ...
          INDIVIDUAL AND NON-CLASS AND NON-REPRESENTATIVE BASIS. ACORNAUTO.COM
          ...
          TRANSACTION. FURTHERMORE, ACORNAUTO.COM AND YOU AGREE THAT NEITHER
          YOUR NOR ACORNAUTO.COM MAY PURSUE THE CLAIMS IN ARBITRATION AS A CLASS
        ...
        <NormalPara>
          AcornAuto.com and you agree that this Section 21 shall be construed
          and interpreted under the Federal Arbitration Act, 9 U.S.C. Section 1,
          et. seq. AcornAuto.com and you agree that any and all Claims shall be
        ...
        <NormalPara>
          AcornAuto.com reserves the right to update and periodically amend
          these Terms and Conditions at its discretion and at any time. If
          AcornAuto.com makes changes to these Terms and Conditions, amendments
          ...
          Services. AcornAuto.com may modify, suspend, discontinue, or restrict
        ...
        <NormalPara>
          ...
          controlled by AcornAuto.com. You agree that AcornAuto.com is not
          responsible or liable for the content, policies or practices of any
          third-party websites or for any non- AcornAuto.com products or
          services. AcornAuto.com does not sponsor or endorse such websites and
          is not responsible for the accuracy, content or any aspect thereof.
          AcornAuto.com disclaims all liability for such websites, and for any
          use of the links to such websites or use of such websites themselves.
          AcornAuto.com also disclaims all liability and makes no
          ...
          AcornAuto.com arising from or based on your use of, or the offer or
          purchase of products or services on or through, such other websites.
          Links do not imply that AcornAuto.com is affiliated or associated
          ...
          trademark, trade name, logo or copyright symbol of AcornAuto.com or
        ...
        <NormalPara>
          ...
          agreements and understandings between you and AcornAuto.com relating
          ...
          written consent of AcornAuto.com. AcornAuto.com may freely do so, in
          whole or in part. These Terms and Conditions will be binding upon the
          successors and permitted assigns of you and AcornAuto.com. These Terms
          and Conditions do not create any third party beneficiary rights.
          AcornAuto.com’s failure or delay in exercising any right, power or
          ...
          under these Terms and Conditions. You and AcornAuto.com are
        ...
        <NormalPara>
          By providing your email address, you agree that AcornAuto.com may send
          ...
          AcornAuto.com may send any legal notices to you via email,
          notification by a message to your account, and/or regular mail.
        </NormalPara>
        <NormalPara>
          If you have any questions or comments about these Terms and
          Conditions, please contact AcornAuto.com at:
        </NormalPara>
        <address>
          Email: info@AcornAuto.com AcornAuto.com <br />
