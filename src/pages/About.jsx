...
const About = () => {
  ...
  return (
    <AboutContainer>
      ...
      <RedBackgroundHeading>About Safe Tire & Auto</RedBackgroundHeading>
      <Container style={{ padding: "2rem 0" }}>
        ...
        {/* <Para>
          Welcome to Safe Tire & Auto, your premier choice for comprehensive
        ...
        <Para>
          ...
          <br />
          <br />
          Thank you for choosing Safe Tire & Auto, where your automotive needs
          are our priority.
        </Para>
        <Heading>RELIABLE SERVICES YOU CAN COUNT ON</Heading>
        <Para>
          When it comes to reliable and convenient auto service or tire service,
          look no further than Safe Tire & Auto. Our dedicated team of expert
          ...
          Visit us today and experience the difference at Safe Tire & Auto!
        </Para>
        <Heading>EXPERT AUTO REPAIR SERVICES</Heading>
        <Para>
          As the premier auto repair shops serving Michigan, Safe Tire & Auto
        ...
        <Para>
          ...
          one-stop automotive repair shop, look no further than Safe Tire &
        ...
        {/* <Heading>
          Safe Tire & Auto: Nurturing Growth and Providing Opportunity
        </Heading>
        <Para>
          Safe Tire & Auto draws its inspiration from the remarkable journey of
          the mighty oak tree. Just like the oak tree begins as a small Safe,
        ...
        <Para>
          Similar to the Safe's transformation into a sturdy oak tree with
          sprawling branches, Safe Tire & Auto strives to provide a strong
