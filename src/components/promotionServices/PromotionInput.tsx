...
import PromotionInputMenu from "./PromotionInputMenu";
...
const PromotionInput = ({
      ...
      <Box mb={4} width="100%">
        <Box display="flex" gap={2} alignItems="start" width="100%">
          <PromotionInputMenu
            ...
            PromotionContentLength={PromotionContentLength}
            index={index}
  ...
  throw Error("Invalid Promotion Input Type");
};
